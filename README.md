...
1. **Install the package**:
   ```bash
   sudo dpkg -i dist/regel-screensaver_0.3.1-1_amd64.deb
...
- `dist/regel-screensaver_0.3.1-1_amd64.deb`
- `dist/source/regel-screensaver_0.3.1-1.dsc`
- `dist/source/regel-screensaver_0.3.1.orig.tar.gz`
